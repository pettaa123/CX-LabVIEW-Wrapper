...
<Library LVVersion="23008000">
	...
	<Item Name="Settings" Type="Folder">
		<Item Name="2D settings.json" Type="Document" URL="../Settings/2D settings.json"/>
		<Item Name="3D settings.json" Type="Document" URL="../Settings/3D settings.json"/>
	</Item>
	<Item Name="SubVIs" Type="Folder">
		<Item Name="Graph under Cursor (SubVI).vi" Type="VI" URL="../SubVIs/Graph under Cursor (SubVI).vi"/>
	</Item>
	<Item Name="3D Acquisition.vi" Type="VI" URL="../3D Acquisition.vi"/>
</Library>
